            ...
            <div class="main-part">
                        ...
                        <div class="tp-banner">
                            <ul>
                                <li data-transition="zoomout" data-slotamount="2" data-masterspeed="1000" data-thumb="" data-saveperformance="on" data-title="Slide">
                                    <img src="<?=base_url('assets_web/');?>images/dummy.png" alt="slidebg1" data-lazyload="<?=base_url('assets_web/');?>images/slider1.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                                    <!-- LAYERS -->
                ...
                <section id="reach-to" class="welcome-part home-icon">
                    <div class="icon-default">
                        <a href="#reach-to" class="scroll"><img src="<?=base_url('assets_web/');?>images/scroll-arrow.png" alt=""></a>
                    </div>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                                ...
                                <p><img src="<?=base_url('assets_web/');?>images/signature.png" alt=""></p>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                                <img src="<?=base_url('assets_web/');?>images/img2.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="float-main">
                        <div class="icon-top-left">
                            <img src="<?=base_url('assets_web/');?>images/icon1.png" alt="">
                        </div>
                        <div class="icon-bottom-left">
                            <img src="<?=base_url('assets_web/');?>images/icon2.png" alt="">
                        </div>
                        <div class="icon-top-right">
                            <img src="<?=base_url('assets_web/');?>images/icon3.png" alt="">
                        </div>
                        <div class="icon-bottom-right">
                            <img src="<?=base_url('assets_web/');?>images/icon4.png" alt="">
                        </div>
                    </div>
                </section>
                <!-- End Welcome Part -->
                <!-- Start Dishes Part -->
                <section class="dishes banner-bg invert invert-black home-icon wow fadeInDown" data-background="<?=base_url('assets_web/');?>images/banner1.jpg" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="icon-default icon-black">
                        <img src="<?=base_url('assets_web/');?>images/icon5.png" alt="">
                    </div>
                    <div class="container">
                        <div class="build-title">
                            <h2>Welcome To The La Boom</h2>
                        ...
                        <div class="slider multiple-items">
                            <div class="product-blog">
                                <img src="<?=base_url('assets_web/');?>images/product1.png" alt="">
                                <h3>Quattro Formaggi</h3>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames</p>
                                <del>$ 55.00</del><strong class="txt-default">$ 18.00</strong>
                            </div>
                            <div class="product-blog">
                                <img src="<?=base_url('assets_web/');?>images/product2.png" alt="">
                                <h3>Vegetarian Pasta</h3>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames</p>
                                <del>$ 55.00</del><strong class="txt-default">$ 18.00</strong>
                            </div>
                            <div class="product-blog">
                                <img src="<?=base_url('assets_web/');?>images/product3.png" alt="">
                ...
                <section class="special-menu bg-skeen home-icon wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="icon-default icon-skeen">
                        <img src="<?=base_url('assets_web/');?>images/icon6.png" alt="">
                    </div>
                    <div class="container">
                        <div class="build-title">
                        ...
                        <div class="menu-wrapper">
                            ...
                            <div class="portfolioContainer row">
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item breakfast">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="<?=base_url('assets_web/');?>images/img3.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item lunch">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="<?=base_url('assets_web/');?>images/img4.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item dessert">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="<?=base_url('assets_web/');?>images/img5.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item dinner">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="<?=base_url('assets_web/');?>images/img6.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item freshfood">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="<?=base_url('assets_web/');?>images/img7.png" alt="">
                                        </span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 isotope-item freshfood">
                                    <div class="menu-list">
                                        <span class="menu-list-product">
                                            <img src="<?=base_url('assets_web/');?>images/img8.png" alt="">
                                        </span>
                    ...
                    <div class="float-main">
                        <div class="icon-top-left">
                            <img src="<?=base_url('assets_web/');?>images/icon7.png" alt="">
                        </div>
                        <div class="icon-bottom-left">
                            <img src="<?=base_url('assets_web/');?>images/icon8.png" alt="">
                        </div>
                        <div class="icon-top-right">
                            <img src="<?=base_url('assets_web/');?>images/icon9.png" alt="">
                        </div>
                        <div class="icon-bottom-right">
                            <img src="<?=base_url('assets_web/');?>images/icon10.png" alt="">
                        </div>
                    </div>
                </section>
                <!-- End Menu Part -->
                ...
                <!-- End Feature Blog -->
                <!-- Start Client Say -->
                <section class="client banner-bg invert invert-black home-icon wow fadeInDown" data-background="images/banner3.jpg" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="icon-default icon-black">
