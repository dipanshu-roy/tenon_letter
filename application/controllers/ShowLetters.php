...
class ShowLetters extends CI_Controller {
    ...
    public function letters(){
	    $employee_id_encript=$this->uri->segment(3);
		...
		$data['employee_detailsss']=$this->Allmodel->selectrow('lt_track_letters',array('employee_id'=>$employee_id,'letter_id'=>$this->uri->segment(2)));
